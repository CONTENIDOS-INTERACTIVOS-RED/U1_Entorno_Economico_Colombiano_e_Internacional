        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde tiempos antiguos, la humanidad ha debido enfrentar una realidad ineludible: los recursos son limitados, mientras que nuestras necesidades y deseos parecen no tener fin. Es en esta tensión donde nace la economía como ciencia social, encargada de estudiar cómo los individuos, las empresas y las sociedades toman decisiones para administrar esos recursos escasos.
              
              p #[b ¡Prepárese para comprender el entorno económico con una visión crítica, estratégica y fundamentada!]
